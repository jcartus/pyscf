...
def kernel(mf, conv_tol=1e-10, conv_tol_grad=None,
           ...
           return_iterations=False, **kwargs):
    ...
    Kwargs:
        ...
        return_iterations : bool
            Whether the number of iterations should be returned with the other 
...
Keyword argument "init_dm" is replaced by "dm0"''')
    ...
    if return_iterations:
        return scf_conv, e_tot, mo_energy, mo_coeff, mo_occ, cycle
    else:
...
# linear dependence, sorting eigenvlaue) to low level ._eigh
    ...
    def scf(self, dm0=None):
        ...
        self.converged, self.e_tot, \
                self.mo_energy, self.mo_coeff, self.mo_occ, self.iterations = \
                kernel(self, self.conv_tol, self.conv_tol_grad,
                       dm0=dm0, callback=self.callback,
                       conv_check=self.conv_check, return_iterations=True)
